...
| ▶️ **Плееры** | Встроенный, VLC, MPV, MPC-BE |
...
🔗 **Последняя сборка:** https://www.virustotal.com/gui/file/SHA256_PLACEHOLDER

> Замените `SHA256_PLACEHOLDER` на актуальную ссылку после загрузки `.exe` на [VirusTotal](https://www.virustotal.com/).
